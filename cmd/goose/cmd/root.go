...
var rootCmd = &cobra.Command{
	Use:   "goose",
	Short: "GoOse is a web article content extractor",
	Long: `GoOse is a powerful web article content extraction tool that can:
- Extract clean text content from web pages
- Remove advertisements and navigation elements
- Extract article metadata like title, author, and publish date
